...
# Dataset
The dataset we used was sourced from this kaggle link:[kaggle](https://www.kaggle.com/becksddf/churn-in-telecoms-dataset). It contained 21 columns and and 3333 rows. It was already pretty much clean with no null values or any outliers.
